...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="billing/index.php" class="nav-item nav-takeorders"><span class='icon-field'><i class="fa fa-list-ol "></i></span> Take Orders</a>
					<a href="recommender/restaurant_bot1.exe" class="nav-item nav-recommender"><span class='icon-field'><i class="fa fa-clipboard-list "></i></span> Recommender</a
				...
				<a href="ChatApp/index.php" class="nav-item nav-chat"><span class='icon-field'><i class="fa fa-list-alt "></i></span> ChatApp</a>
				<?php if($_SESSION['login_type'] == 1): ?>
				<div class="mx-2 text-white">Systems</div>
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users "></i></span> Users</a>
			    <a href="index.php?page=feedback" class="nav-item nav-feedback"><span class='icon-field'><i class="fa fa-th-list"></i></span> Feedback</a>
